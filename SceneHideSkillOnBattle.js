 ...
 * 
 * 戦闘中の技の表示非表示を設定する画面呼び出しのためのプラグインコマンド
 * SCENE_HIDESKILL
 * 
 * 利用規約
 * クレジットの表記等は特に必要ありません
...
Window_HideSkillList.prototype.initialize = function(x, y, width, height) {
...
Scene_HideSkill.prototype.createItemWindow = function() {
    ...
    this._itemWindow = new Window_HideSkillList(wx, wy, ww, wh);
...
(function(){
    ...
    //実際に戦闘画面で表示されるスキル一覧
    var Window_SkillList_includes = Window_BattleSkill.prototype.includes;
